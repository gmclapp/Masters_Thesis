...
def ORC_model(cond_pres, boil_pres, eff_t, eff_p,fluid):
...
if __name__ == '__main__':
    ...
    working_fluid = input("Enter working fluid.\n>>>")
    ...
    (Wm,efficiency,boil_temp,cond_temp,Qin_m,Qout_m) = ORC_model(condenser_pressure,boiler_pressure,turbine_efficiency,pump_efficiency,working_fluid)
